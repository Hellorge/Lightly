...
#### Void Linux
```
sudo xbps-install extra-cmake-modules base-devel kdecoration-devel kguiaddons-devel kconfigwidgets-devel kwindowsystem-devel kiconthemes-devel qt6-base qt6-base-devel qt6-tools-devel extra-cmake-modules base-devel kdecoration-devel kguiaddons-devel kconfigwidgets-devel kwindowsystem-devel kiconthemes-devel
```
